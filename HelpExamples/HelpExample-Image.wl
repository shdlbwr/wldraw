...
dwExampleImageObjectMultiplyPreview[]:= ColorReplace[ImageResize[ImageCrop[ImageMultiply[Graphics[Inset[$dwImageFilterImageDefault]],Graphics[Inset[$dwImageFilterImageDefault,{.05,.05}],PlotRange->.2],1]],100],White->$dwHelpBackgroundColor,.1]
