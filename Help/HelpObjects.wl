...
Grid[{
	{$dwIconShapeGraph/.{GrayLevel[.7] -> GrayLevel[.3]}, " Adjust the vertex quantity and layout to create a variety of generic graphs."}
}],
Style["Random", Sequence@@$dwHelpSubheadStyle],
Grid[{
	{$dwIconShapeRandomPoints/.{GrayLevel[.7] -> GrayLevel[.3]}, " Fill selected shape with random points."}
}],
...
Style[Grid[
	Riffle[
	Partition[{
		Magnify[Graphics[Inset[$dwImageFilterImageDefault],ImageSize->{200,200}],1/3],
		Magnify[Graphics[Inset[Binarize[$dwImageFilterImageDefault,.5]],ImageSize->{200,200}],1/3],
		Magnify[Graphics[Inset[ImageEffect[$dwImageFilterImageDefault,{"Comics",{0.255, 0.745}}]],ImageSize->{200,200}],1/3],
		Magnify[Graphics[Inset[ImageEffect[$dwImageFilterImageDefault,{"Embossing",5}]],ImageSize->{200,200}],1/3],
		Magnify[Graphics[Inset[ImageAdjust[GradientFilter[$dwImageFilterImageDefault,4]]],ImageSize->{200,200}],1/3],
		Magnify[Graphics[Inset[ImageEffect[$dwImageFilterImageDefault,{"Jitter",2}]],ImageSize->{200,200}],1/3],
		Magnify[Graphics[Inset[EdgeDetect[$dwImageFilterImageDefault,4]],ImageSize->{200,200}],1/3],
		Magnify[Graphics[Inset[ImageEffect[$dwImageFilterImageDefault,{"EdgeStylization",16}, RandomSeeding->1]],ImageSize->{200,200}],1/3],
		Magnify[Graphics[Inset[ImageAdjust[RidgeFilter[$dwImageFilterImageDefault,4]]],ImageSize->{200,200}],1/3],
		Magnify[Graphics[Inset[ImageEffect[$dwImageFilterImageDefault,{"TornFrame",Scaled[.2],{Bottom},.2},RandomSeeding->12]],ImageSize->{200,200}],1/3],
		Magnify[Graphics[Inset[ImageEffect[$dwImageFilterImageDefault,{"Vignette",45,Hue[.25,.7,.7]}]],ImageSize->{200,200}],1/3],
		Magnify[Graphics[Inset[ImageEffect[$dwImageFilterImageDefault,{"GaussianNoise",.5}, RandomSeeding->1]],ImageSize->{200,200}],1/3]
	}, 6, 6, 1, {}], 
	Partition[{
