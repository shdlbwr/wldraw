						...
						Framed[Column[{
							...
							Dynamic@If[$dwHelpTools === "",
								Column[{
									...
									Graphics[{}, ImageSize->{10,516}](* change vertical size here if changing Pane vertical size *)
								}],
								dwHelpNavigationButtons[]
							]
...
- Message bar at bottom of window displays info such as distance and totals.
