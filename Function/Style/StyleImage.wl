								...
								Column[{
									...
									Dynamic@If[$dwSelected === {} || Length[$dwStyle[[$dwSelected[[1]],4]]] < n,
										...
										Which[
											...
											MemberQ[{"Color","FrameVignette","RemoveColor","KeepColor"}, $dwStyle[[$dwSelected[[1]],4,n,1]]],
												Row[{
													ColorSetter[Dynamic[$dwStyle[[$dwSelected[[1]],4,n,5]]], ImageSize->Tiny], Spacer[5],
													Button[Style["- ", White], $dwStyle[[$dwSelected[[1]],4,n,2]] = Round[Max[$dwStyle[[$dwSelected[[1]],4,n,2]] - .05, $dwStyle[[$dwSelected[[1]],4,n,3]]],.05], Appearance->None],
													...
													Button[Style[" +", White], $dwStyle[[$dwSelected[[1]],4,n,2]] = Round[Min[$dwStyle[[$dwSelected[[1]],4,n,2]] + .05, $dwStyle[[$dwSelected[[1]],4,n,4]]],.05], Appearance->None],
