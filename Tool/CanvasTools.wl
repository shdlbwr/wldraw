		...
		Panel[Grid[{
				...
				{Grid[{
					{Row[{Checkbox[Dynamic@$dwShowGrid], " show grid", Spacer[77], 
						"2D grid range ", PopupMenu[Dynamic@$dwGrid2DRange, Range[4]]}]},
					{Row[{Checkbox[Dynamic@$dwShowAxes], " show axis", Spacer[78],
						"3D grid range ", PopupMenu[Dynamic@$dwGrid3DRange, Range[4]]}]},
					{Row[{Spacer[{0,18}], Checkbox[Dynamic@$dwFixScaleAspectRatioOpenedFile], " fix imported file"}]}
