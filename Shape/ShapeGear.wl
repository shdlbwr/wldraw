		...
		DynamicModule[{scale = .4},
			Pane[
				Column[{
					...
					Grid[{{
						Button[Dynamic@Graphics[If[$dwShapeGearHead===BSplineCurve,FilledCurve[$dwShapeGearHead[#[[1,1]],SplineClosed->True]],#[[1]]]&/@{Cases[dwGear["Teeth"->3,"ToothHeight"->1,"ToothWidth"->.1,"ToothCurveMidPoint"->.5,"ToothCurve"->.4,"ToothPeakSize"->.2,"ToothBaseSize"->0], _Polygon, Infinity]}],
						...
						Button[Dynamic@Graphics[If[$dwShapeGearHead===BSplineCurve,FilledCurve[$dwShapeGearHead[#[[1,1]],SplineClosed->True]],#[[1]]]&/@{Cases[dwGear["Teeth"->5,"ToothHeight"->.62,"ToothWidth"->0,"ToothCurveMidPoint"->0,"ToothCurve"->0,"ToothPeakSize"->0,"ToothBaseSize"->0], _Polygon, Infinity]}],
						...
						Button[Dynamic@Graphics[If[$dwShapeGearHead===BSplineCurve,FilledCurve[$dwShapeGearHead[#[[1,1]],SplineClosed->True]],#[[1]]]&/@{Cases[dwGear["Teeth"->8,"ToothHeight"->3/8,"ToothWidth"->.1,"ToothCurveMidPoint"->0.5,"ToothCurve"->0.5,"ToothPeakSize"->0.04,"ToothBaseSize"->0], _Polygon, Infinity]}],
						...
						Button[Dynamic@Graphics[If[$dwShapeGearHead===BSplineCurve,FilledCurve[$dwShapeGearHead[#[[1,1]],SplineClosed->True]],#[[1]]]&/@{Cases[dwGear["Teeth"->6,"ToothHeight"->1,"ToothWidth"->.3696,"ToothCurveMidPoint"->.5,"ToothCurve"->0,"ToothPeakSize"->0,"ToothBaseSize"->.25], _Polygon, Infinity]}],
						...
						Button[Dynamic@Graphics[If[$dwShapeGearHead===BSplineCurve,FilledCurve[$dwShapeGearHead[#[[1,1]],SplineClosed->True]],#[[1]]]&/@{Cases[dwGear["Teeth"->8,"ToothHeight"->.5,"ToothWidth"->.24,"ToothCurveMidPoint"->0,"ToothCurve"->0,"ToothPeakSize"->0,"ToothBaseSize"->0], _Polygon, Infinity]}],
							...
							$dwShapeGearOptions["ToothCurveMidPoint"]=0;$dwShapeGearOptions["ToothCurve"]=0;$dwShapeGearOptions["ToothPeakSize"]=0;$dwShapeGearOptions["ToothBaseSize"]=0,$dwPresetButtonStyle],
						Button[Dynamic@Graphics[If[$dwShapeGearHead===BSplineCurve,FilledCurve[$dwShapeGearHead[#[[1,1]],SplineClosed->True]],#[[1]]]&/@{Cases[dwGear["Teeth"->8,"ToothHeight"->.5,"ToothWidth"->.36,"ToothCurveMidPoint"->0,"ToothCurve"->0,"ToothPeakSize"->0,"ToothBaseSize"->0], _Polygon, Infinity]}],
							...
							$dwShapeGearOptions["ToothCurveMidPoint"]=0;$dwShapeGearOptions["ToothCurve"]=0;$dwShapeGearOptions["ToothPeakSize"]=0;$dwShapeGearOptions["ToothBaseSize"]=0,$dwPresetButtonStyle],
						Button[Dynamic@Graphics[If[$dwShapeGearHead===BSplineCurve,FilledCurve[$dwShapeGearHead[#[[1,1]],SplineClosed->True]],#[[1]]]&/@{Cases[dwGear["Teeth"->8,"ToothHeight"->.4,"ToothWidth"->.2,"ToothCurveMidPoint"->1,"ToothCurve"->1,"ToothPeakSize"->.3,"ToothBaseSize"->.4], _Polygon, Infinity]}],
						...
						Button[Dynamic@Graphics[If[$dwShapeGearHead===BSplineCurve,FilledCurve[$dwShapeGearHead[#[[1,1]],SplineClosed->True]],#[[1]]]&/@{Cases[dwGear["Teeth"->12,"ToothHeight"->.36,"ToothWidth"->.15,"ToothCurveMidPoint"->0,"ToothCurve"->0,"ToothPeakSize"->0,"ToothBaseSize"->0], _Polygon, Infinity]}],
						...
						Button[Dynamic@Graphics[If[$dwShapeGearHead===BSplineCurve,FilledCurve[$dwShapeGearHead[#[[1,1]],SplineClosed->True]],#[[1]]]&/@{Cases[dwGear["Teeth"->6,"ToothHeight"->.3,"ToothWidth"->.31,"ToothCurveMidPoint"->0,"ToothCurve"->0,"ToothPeakSize"->.2,"ToothBaseSize"->.6], _Polygon, Infinity]}],
						...
						Button[Dynamic@Graphics[If[$dwShapeGearHead===BSplineCurve,FilledCurve[$dwShapeGearHead[#[[1,1]],SplineClosed->True]],#[[1]]]&/@{Cases[dwGear["Teeth"->9,"ToothHeight"->1,"ToothWidth"->0,"ToothCurveMidPoint"->0,"ToothCurve"->1,"ToothPeakSize"->1,"ToothBaseSize"->0], _Polygon, Infinity]}],
						...
						Button[Dynamic@Graphics[If[$dwShapeGearHead===BSplineCurve,FilledCurve[$dwShapeGearHead[#[[1,1]],SplineClosed->True]],#[[1]]]&/@{Cases[dwGear["Teeth"->12,"ToothHeight"->.6,"ToothWidth"->.37,"ToothCurveMidPoint"->.5,"ToothCurve"->.4,"ToothPeakSize"->0,"ToothBaseSize"->.04], _Polygon, Infinity]}],
						...
						Button[Dynamic@Graphics[If[$dwShapeGearHead===BSplineCurve,FilledCurve[$dwShapeGearHead[#[[1,1]],SplineClosed->True]],#[[1]]]&/@{Cases[dwGear["Teeth"->16,"ToothHeight"->.5,"ToothWidth"->.8,"ToothCurveMidPoint"->0,"ToothCurve"->1,"ToothPeakSize"->1,"ToothBaseSize"->1], _Polygon, Infinity]}],
						...
						Button[Dynamic@Graphics[If[$dwShapeGearHead===BSplineCurve,FilledCurve[$dwShapeGearHead[#[[1,1]],SplineClosed->True]],#[[1]]]&/@{Cases[dwGear["Teeth"->9,"ToothHeight"->.5,"ToothWidth"->.49,"ToothCurveMidPoint"->1,"ToothCurve"->1,"ToothPeakSize"->1,"ToothBaseSize"->0], _Polygon, Infinity]}],
						...
						Button[Dynamic@Graphics[If[$dwShapeGearHead===BSplineCurve,FilledCurve[$dwShapeGearHead[#[[1,1]],SplineClosed->True]],#[[1]]]&/@{Cases[dwGear["Teeth"->5,"ToothHeight"->0,"ToothWidth"->.37,"ToothCurveMidPoint"->.5,"ToothCurve"->1,"ToothPeakSize"->.35,"ToothBaseSize"->.35], _Polygon, Infinity]}],
						...
						Button[Dynamic@Graphics[If[$dwShapeGearHead===BSplineCurve,FilledCurve[$dwShapeGearHead[#[[1,1]],SplineClosed->True]],#[[1]]]&/@{Cases[dwGear["Teeth"->10,"ToothHeight"->.5,"ToothWidth"->.56,"ToothCurveMidPoint"->1,"ToothCurve"->.6,"ToothPeakSize"->1,"ToothBaseSize"->.3], _Polygon, Infinity]}],
						...
						Button[Dynamic@Graphics[If[$dwShapeGearHead===BSplineCurve,FilledCurve[$dwShapeGearHead[#[[1,1]],SplineClosed->True]],#[[1]]]&/@{Cases[dwGear["Teeth"->32,"ToothHeight"->.5,"ToothWidth"->1,"ToothCurveMidPoint"->.5,"ToothCurve"->.8,"ToothPeakSize"->.3,"ToothBaseSize"->1], _Polygon, Infinity]}],
						...
						Button[Dynamic@Graphics[If[$dwShapeGearHead===BSplineCurve,FilledCurve[$dwShapeGearHead[#[[1,1]],SplineClosed->True]],#[[1]]]&/@{Cases[dwGear["Teeth"->2,"ToothHeight"->1,"ToothWidth"->.3696,"ToothCurveMidPoint"->.5,"ToothCurve"->0,"ToothPeakSize"->0,"ToothBaseSize"->.25], _Polygon, Infinity]}],
							...
							$dwShapeGearOptions["ToothCurveMidPoint"]=.5;$dwShapeGearOptions["ToothCurve"]=0;$dwShapeGearOptions["ToothPeakSize"]=0;$dwShapeGearOptions["ToothBaseSize"]=.25,$dwPresetButtonStyle],
						Button[Dynamic@Graphics[If[$dwShapeGearHead===BSplineCurve,FilledCurve[$dwShapeGearHead[#[[1,1]],SplineClosed->True]],#[[1]]]&/@{Cases[dwGear["Teeth"->2,"ToothHeight"->.26,"ToothWidth"->.74,"ToothCurveMidPoint"->.5,"ToothCurve"->.4,"ToothPeakSize"->0,"ToothBaseSize"->.75], _Polygon, Infinity]}],
						...
						Button[Dynamic@Graphics[If[$dwShapeGearHead===BSplineCurve,FilledCurve[$dwShapeGearHead[#[[1,1]],SplineClosed->True]],#[[1]]]&/@{Cases[dwGear["Teeth"->2,"ToothHeight"->.25,"ToothWidth"->.74,"ToothCurveMidPoint"->.5,"ToothCurve"->.4,"ToothPeakSize"->0,"ToothBaseSize"->0], _Polygon, Infinity]}],
						...
						Button[Dynamic@Graphics[If[$dwShapeGearHead===BSplineCurve,FilledCurve[$dwShapeGearHead[#[[1,1]],SplineClosed->True]],#[[1]]]&/@{Cases[dwGear["Teeth"->2,"ToothHeight"->1,"ToothWidth"->0,"ToothCurveMidPoint"->.5,"ToothCurve"->.5,"ToothPeakSize"->.5,"ToothBaseSize"->1], _Polygon, Infinity]}],
						...
						Button[Dynamic@Graphics[If[$dwShapeGearHead===BSplineCurve,FilledCurve[$dwShapeGearHead[#[[1,1]],SplineClosed->True]],#[[1]]]&/@{Cases[dwGear["Teeth"->2,"ToothHeight"->.25,"ToothWidth"->.74,"ToothCurveMidPoint"->0,"ToothCurve"->.5,"ToothPeakSize"->.85,"ToothBaseSize"->1], _Polygon, Infinity]}],
							$dwShapeGearOptions["AutoToothShape"]=False;$dwShapeGearOptions["Teeth"]=2;$dwShapeGearOptions["ToothHeight"]=.25;$dwShapeGearOptions["ToothWidth"]=.74;
						...
						Button[Dynamic@Graphics[If[$dwShapeGearHead===BSplineCurve,FilledCurve[$dwShapeGearHead[#[[1,1]],SplineClosed->True]],#[[1]]]&/@{Cases[dwGear["Teeth"->2,"ToothHeight"->1,"ToothWidth"->1,"ToothCurveMidPoint"->.65,"ToothCurve"->.55,"ToothPeakSize"->.5,"ToothBaseSize"->1], _Polygon, Infinity]}],
						...
						Button[Dynamic@Graphics[If[$dwShapeGearHead===BSplineCurve,FilledCurve[$dwShapeGearHead[#[[1,1]],SplineClosed->True]],#[[1]]]&/@{Cases[dwGear["Teeth"->2,"ToothHeight"->0,"ToothWidth"->1,"ToothCurveMidPoint"->.5,"ToothCurve"->.5,"ToothPeakSize"->.5,"ToothBaseSize"->1], _Polygon, Infinity]}],
							...
							$dwShapeGearOptions["ToothCurveMidPoint"]=.5;$dwShapeGearOptions["ToothCurve"]=.5;$dwShapeGearOptions["ToothPeakSize"]=.5;$dwShapeGearOptions["ToothBaseSize"]=1,$dwPresetButtonStyle],
						Button[Dynamic@Graphics[If[$dwShapeGearHead===BSplineCurve,FilledCurve[$dwShapeGearHead[#[[1,1]],SplineClosed->True]],#[[1]]]&/@{Cases[dwGear["Teeth"->2,"ToothHeight"->1,"ToothWidth"->1,"ToothCurveMidPoint"->1,"ToothCurve"->.3,"ToothPeakSize"->.7,"ToothBaseSize"->1], _Polygon, Infinity]}],
							$dwShapeGearOptions["AutoToothShape"]=False;$dwShapeGearOptions["Teeth"]=2;$dwShapeGearOptions["ToothHeight"]=1;$dwShapeGearOptions["ToothWidth"]=1;
