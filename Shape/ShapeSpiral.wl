		...
		DynamicModule[{turns = 4, spread = 1, plotPts = 40, scale = .2, finalPts, finalPtsScale},
			Pane[
				Dynamic@Column[{
					...
					Grid[{{
						Button[Graphics[{ParametricPlot[{(u^1 Pi)Cos[u],(u^1 Pi) Sin[u]},{u,.01,2 Pi},DisplayFunction->(Cases[#[[1]],_Line,Infinity][[1]]&)]}],turns=2;spread=1,$dwPresetButtonStyle],
						Button[Graphics[{ParametricPlot[{(u^1 Pi)Cos[u],(u^1 Pi) Sin[u]},{u,.01,4 Pi},DisplayFunction->(Cases[#[[1]],_Line,Infinity][[1]]&)]}],turns=4;spread=1,$dwPresetButtonStyle],
						Button[Graphics[{ParametricPlot[{(u^1 Pi)Cos[u],(u^1 Pi) Sin[u]},{u,.01,6 Pi},DisplayFunction->(Cases[#[[1]],_Line,Infinity][[1]]&)]}],turns=6;spread=1,$dwPresetButtonStyle],
						Button[Graphics[{ParametricPlot[{(u^2 Pi)Cos[u],(u^2 Pi) Sin[u]},{u,.01,2 Pi},DisplayFunction->(Cases[#[[1]],_Line,Infinity][[1]]&)]}],turns=2;spread=2,$dwPresetButtonStyle],
						Button[Graphics[{ParametricPlot[{(u^2 Pi)Cos[u],(u^2 Pi) Sin[u]},{u,.01,4 Pi},DisplayFunction->(Cases[#[[1]],_Line,Infinity][[1]]&)]}],turns=4;spread=2,$dwPresetButtonStyle],
						Button[Graphics[{ParametricPlot[{(u^2 Pi)Cos[u],(u^2 Pi) Sin[u]},{u,.01,6 Pi},DisplayFunction->(Cases[#[[1]],_Line,Infinity][[1]]&)]}],turns=6;spread=2,$dwPresetButtonStyle]
					}},Spacings->{0,0}],
